...
void settings_t::init ( ) {
	...
	option_t::add_bool ( _ ( "visuals.player_enable" ), false );
	option_t::add_bool ( _ ( "visuals.player_dormant" ), false );
	option_t::add_bool ( _ ( "visuals.player_box" ), false );
	option_t::add_color ( _ ( "visuals.player_box_color" ), sesui::color ( 1.0f, 1.0f, 1.0f, 1.0f ) );
	option_t::add_bool ( _ ( "visuals.flags_armor" ), false );
	option_t::add_bool ( _ ( "visuals.flags_money" ), false );
	option_t::add_bool ( _ ( "visuals.flags_bomb" ), false );
	option_t::add_bool ( _ ( "visuals.flags_defuser" ), false );
	option_t::add_bool ( _ ( "visuals.flags_scoped" ), false );
	option_t::add_bool ( _ ( "visuals.flags_distance" ), false );
	option_t::add_bool ( _ ( "visuals.player_name" ), false );
	option_t::add_color ( _ ( "visuals.player_name_color" ), sesui::color ( 1.0f, 1.0f, 1.0f, 1.0f ) );
	option_t::add_bool ( _ ( "visuals.player_health" ), false );
	option_t::add_bool ( _ ( "visuals.player_weapon_name" ), false );
	option_t::add_bool ( _ ( "visuals.player_weapon_icon" ), false );
	option_t::add_bool ( _ ( "visuals.player_ammo" ), false );
	option_t::add_color ( _ ( "visuals.player_ammo_color" ), sesui::color ( 1.0f, 1.0f, 1.0f, 1.0f ) );
	option_t::add_bool ( _ ( "visuals.player_lby_indicator" ), false );
	option_t::add_color ( _ ( "visuals.player_lby_indicator_color" ), sesui::color ( 1.0f, 1.0f, 1.0f, 1.0f ) );
}
