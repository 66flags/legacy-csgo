...
namespace sesui {
	...
	struct style_t {
		color window_background = color ( 0.14f, 0.13f, 0.16f, 1.0f );
		color window_foreground = color ( 0.26f, 0.27f, 0.3f, 1.0f );
		color window_borders = color ( 0.35f, 0.36f, 0.38f, 1.0f );
		color window_accent = color ( 0.2f, 0.18f, 0.25f, 1.0f );
		color window_accent_borders = color ( 0.35f, 0.36f, 0.38f, 1.0f );

		vec2 window_min_size = vec2 ( 300.0f, 300.0f );

		/* percentage */
		float titlebar_height = 0.05f /* 1/10 */;
		float group_titlebar_height = 0.14f /* 1/20 */;
		...
		color control_accent = color ( 0.85f, 0.83f, 0.96f, 1.0f );
		color control_accent_borders = color ( 0.77f, 0.75f, 0.88f, 1.0f );
		color tab_selected = color ( 0.26f, 0.25f, 0.32f, 1.0f );
		...
		vec2 slider_size = vec2 ( 180.0f, 8.0f );
		vec2 button_size = vec2 ( 180.0f, 20.0f );
